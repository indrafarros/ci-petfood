...
<script>
    ...
    function data_table() {
        var table = $('#menu_table').DataTable({
            ...
            "ajax": {
                "url": "<?= base_url('dashboard/serverside_role_access') ?>",
                "dataType": "json",
                "type": "POST",
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", "#btnViewRoles", function(e) {
            ...
            $.ajax({
                url: "<?= base_url('dashboard/viewRole') ?>",
                type: "post",
                dataType: "json",
                data: {
                    id_role: id,
        ...
        $("#btnAddRole").click(function(e) {
            ...
            if (role_name == '') {
                ...
                $.ajax({
                    url: "<?= base_url('dashboard/addRole') ?>",
                    type: 'post',
                    dataType: 'json',
                    data: {
                        role_name: role_name,
        ...
        $(document).on('click', "#btnDeleteRole", function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?= base_url('dashboard/deleteRole') ?>',
                        type: 'post',
                        dataType: 'json',
                        data: {
                            id_role: id,
        ...
        $(document).on('click', '#btnEditRole', function(e) {
            ...
            var id = $(this).data('id');
            $.ajax({
                url: '<?= base_url('dashboard/getEditRole') ?>',
                type: 'post',
                dataType: 'json',
                data: {
                    id_role: id,
        ...
        $(document).on('click', '#btnSubmitRole', function(e) {
            ...
            if (id == '' || menu_name == '') {
                ...
                $.ajax({
                    url: '<?= base_url('dashboard/submitRoleAccess') ?>',
                    dataType: 'json',
                    type: 'post',
                    data: {
                        id_edit_name: id,
